    ...
    /*public CDBProvisionRequest(String request) throws ErrorMessage {
        ...
        if (!request.contains("serviceFlags")) {
            ...
            if (!request.contains("transactionalPurchases")) {
                ...
                if (row_aux.equals("0")) {
                    this.serviceFlags.transactionalPurchases(ProvisionOttUserBASEFlagsServiceFlags.TransactionalPurchasesEnum.NUMBER_0);
                } else if (row_aux.equals("1")) {
                    this.serviceFlags.transactionalPurchases(ProvisionOttUserBASEFlagsServiceFlags.TransactionalPurchasesEnum.NUMBER_1);
                } else {
