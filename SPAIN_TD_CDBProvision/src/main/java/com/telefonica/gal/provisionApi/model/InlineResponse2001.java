...
public class InlineResponse2001   {
  @JsonProperty("items")
  @Valid
  private List<Voucher> items = null;

  public InlineResponse2001 items(List<Voucher> items) {
    this.items = items;
    return this;
  }

  public InlineResponse2001 addItemsItem(Voucher itemsItem) {
    if (this.items == null) {
  ...
  */
  ...
  public void setItems(List<Voucher> items) {
    this.items = items;
  }
