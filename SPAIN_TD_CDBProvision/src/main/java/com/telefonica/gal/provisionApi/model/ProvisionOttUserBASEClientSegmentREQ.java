...
/**
 * ProvisionOttUserBASEClientSegmentREQ
 */
...
public class ProvisionOttUserBASEClientSegmentREQ   {
  @JsonProperty("clientSegmentName")
  private String clientSegmentName;

  public ProvisionOttUserBASEClientSegmentREQ clientSegmentName(String clientSegmentName) {
  ...
  */
  @ApiModelProperty(example = "SAT1", required = true, value = "Client segment the user belongs to (referenced by its name).  This parameter defines which products may be contracted or purchased by this user. ")
  @NotNull
  ...
  public boolean equals(java.lang.Object o) {
    ...
    ProvisionOttUserBASEClientSegmentREQ provisionOttUserBASEClientSegmentREQ = (ProvisionOttUserBASEClientSegmentREQ) o;
    return Objects.equals(this.clientSegmentName, provisionOttUserBASEClientSegmentREQ.clientSegmentName);
  }
  ...
  public String toString() {
    ...
    sb.append("class ProvisionOttUserBASEClientSegmentREQ {\n");
