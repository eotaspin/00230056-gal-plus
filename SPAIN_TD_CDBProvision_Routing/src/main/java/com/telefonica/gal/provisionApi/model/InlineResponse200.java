...
public class InlineResponse200   {
  @JsonProperty("items")
  @Valid
  private List<SubscribedProduct> items = null;

  public InlineResponse200 items(List<SubscribedProduct> items) {
    this.items = items;
    return this;
  }

  public InlineResponse200 addItemsItem(SubscribedProduct itemsItem) {
    if (this.items == null) {
  ...
  */
  ...
  public List<SubscribedProduct> getItems() {
    return items;
  }

  public void setItems(List<SubscribedProduct> items) {
    this.items = items;
  }
